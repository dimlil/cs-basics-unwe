...
namespace task4
{
    class MainClass
    {
        ...
        {
            Console.Write("Enter first EGN: ");
            String egn1 = Console.ReadLine();
            int cityCode1 = int.Parse(egn1.Substring(6, 3));

            string city1 = GetCityName(cityCode1);

            Console.Write("Enter second EGN: ");
            String egn2 = Console.ReadLine();
            int cityCode2 = int.Parse(egn2.Substring(6, 3));

            string city2 = GetCityName(cityCode2);

            if (city1 == city2)
            {
                Console.WriteLine("Born in same city");
            }
            else
            {
                Console.WriteLine("Born in different cities");
            }
        }
    }
}
